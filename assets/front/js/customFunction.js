        			 ...
        			 $.each(res,function(key, value)
                        {
                            ...
                            var html =  '<div class="preview-image preview-show-' + value.id + '">' +
                                          ...
                                          '<div class="image-zone"><img id="pro-img-' + value.id + '" src="http://solaris.projexonlineservices.com/uploads/document/' + imgURL + '"></div>' +
                                          '<div class="tools-edit-image"><a href="http://solaris.projexonlineservices.com/uploads/document/' + value.doc_image + '" download data-no="' + value.id + '" class="btn btn-light btn-edit-image"><i class="fa fa-download" aria-hidden="true"></i></a></div>' +
                                          '</div>';
