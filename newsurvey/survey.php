                ...
                <nav class="navbar top-navbar col-lg-12 col-12 p-0">
                    <div class="container">
                        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                            <a class="navbar-brand brand-logo" href="https://projexcost.com/newsurvey"><img src="assets/images/Projex_Strap_blk.png" alt="logo" style="height: 60px;" /></a>
                            <a class="navbar-brand brand-logo-mini" href="https://projexcost.com/newsurvey"><img src="assets/images/Projex_Strap_blk.png" alt="logo" style="height: 60px;" /></a>
                        </div>
                    </div>
                </nav>
            </div>
                            ...
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <br>
                                        <a class="btn btn-success prev" id="prev" href="https://projexcost.com/newsurvey">BACK</a>
                                        <a class="btn btn-success next" id="next" href="https://projexcost.com/survey1.php">NEXT</a>
                                    </div>
                                </div>
                            </div> 
                            <br>
