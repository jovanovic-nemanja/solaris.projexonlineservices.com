                          ...
                          <h6 class="mb-0" style="color: white;">
                            <a data-toggle="collapse" href="#collapse-<?= $i; ?>" aria-expanded="false" aria-controls="collapse-<?= $i; ?>" class="collapsed">
    						  ...
    						  <div class="aa-bb">
    							...
    							<span class="ab-3"><span class="currencyConvert"><?= number_format(ceil($value['sumSellingCost']),2,'.',','); ?></span></span>
    							 <?php } ?>
    						  </div>
                            </a>
                          </h6>
    											...
    											<div class="subcat">
    												<h4 style="font-size: 1rem!important; width: 40%;">
    													...
    													<div class="aa-bb" style="">
    														...
    														<span class="ab-3"><span class="currencyConvert"><?php echo number_format(ceil($subvalue['sumSellingCost']),2,'.',','); ?></span></span>
    														<?php } ?>
    											  ...
    											  <tbody>
    												  ...
    												  <tr class="record">
    													  ...
    													  <td style="width:14%" class="">
    														   <p style=""><span class="currencyConvert"><?= number_format(ceil($lineItem['total_cost']),2,'.',','); ?></span></p>
    													  </td>
