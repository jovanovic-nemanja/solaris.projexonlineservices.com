  ...
  <div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
        <h3 class="page-title">
            <?php echo isset($edit_cost_type->title) ? 'Edit New Job Type' : 'Add New Job Type'; ?>
        </h3>
      </div>
      <div class="row">
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              <form class="" method="post" action="" id="addcost_type">
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Title</label>
                  <input type="text" class="form-control pulsate" name="title" id="title" value="<?php echo isset($edit_cost_type->title) ? $edit_cost_type->title: ''; ?>" placeholder="">
                ...
                <div class="form-group col-md-12 text-right">
                  <button type="button" class="btn btn-success mb-2" onclick="saveProfile('addcost_type','addCostType')">Submit</button>
                </div>
              </form>
            </div>
          </div>
            ...
            <div class="card-body">       
                <div class="table-responsive">
                    <table id="order-listing" class="table">
                        ...
                        <tbody>
                          <?php $i=1; foreach ($cost_type as $key => $value) { ?>
                            <tr>
                              ...
                              <td style="width: 10%; word-wrap: break-word;">
                                <a title="View" type="button" id="<?=$value['id']; ?>" href="<?=  base_url('admin/app/cost_type?action=edit&id='.$value['id'].''); ?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
<script>
    $(document).ready(function() {
        $(".delete_row").click(function(e){
            ...
            var deldata = {"id":getvalue,"table":'cost_type'};
