					                              		...
					                              		<div class="aa-bb" style="top: -8px;">
    													  	<?php if($value['sumSellingCost']){ ?>
    														    <span class="ab-2" style="padding-right: 0px;">
    														    	<span class="totcurr totalcostsum-<?= $value['cat_id']; ?> currencyConvert"><?= number_format(ceil($value['sumTotalCost']),2); ?></span>&nbsp;|&nbsp;
    														    </span>
    															...
    															<span class="ab-3" style="padding-right: 25px;">
    																<span class="selcurr sellingPriceSum-<?= $value['cat_id']; ?> currencyConvert"><?= number_format(ceil($value['sumSellingCost']),2); ?></span>
    															</span>
    														<?php } else{ ?>
    														 	<span class="ab-2" style="padding-right: 0px;">
																		...
																		<a class="collapsed" role="button" data-toggle="collapse" href="#collapse-<?=$i?>-<?=$j?>" aria-expanded="false" aria-controls="collapse-1-1">
    																		...
    																		<div class="aa-bb" style="top: 0px;">
    																			<?php if(!empty($subvalue['sumTotalCost'])){ ?>
        																			<span class="ab-2"><span class="totcurr subtotalcostsum-<?=$subvalue['id']; ?> urrencyConvert"><?php echo ' '.number_format(ceil($subvalue['sumTotalCost']),2); ?> &nbsp;&nbsp; | &nbsp;&nbsp;</span></span>
        																			<span class="ab-2 avgoh-<?=$subvalue['id'];?>"><?php echo round ($subvalue['sumTotalCost']/$subvalue['sumSellingCost'],2); ?>&nbsp;&nbsp; | &nbsp;&nbsp;</span>
        																			<span class="ab-3" style="padding-right: 35px;"><span class="selcurr subsellingPriceSum-<?=$subvalue['id']; ?> currencyConvert"><?php echo ' '.number_format(ceil($subvalue['sumSellingCost']),2); ?></span></span>
    																			<?php } else{ ?>
																							...
																							<form method="post" id="lineItemForm-<?= $lineItem['id']; ?>">
																							 	<td style="width:13%" class="geeks">
																							  	...
																							  	<td style="width:14%" class="">
																								   	<p style="color: green;"><span class="currencyConvert"><?= number_format(ceil($lineItem['total_cost']),2); ?></span></p>
																							  	</td>
																							  	<td style="width:10%" class="">
                    				     ...
                    				     <table class="table">
                    					    <tbody>
                    						  <tr>
                    							...
                    							<td style="width:50%;"><p class="text-right mb-0"><strong>AED <span class="totalsellingPrice"><?= number_format(ceil($costSheetTotal[0]->sellingPriceSum),2); ?></span></strong></p></td>
                    						  </tr>
                    						  <tr>
                    							<td style="width:50%;">
                    						  ...
                    						  <tr>
                    							...
                    							<td style="width:40%;"><p class="text-right mb-0"><strong><span class="total">AED <?= number_format(ceil($totalCost),2); ?></span></strong></p></td>
                    						  </tr>
                    						</tbody>
                    				    </table>
                    				</div>
