        ...
        <div class="col-md-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="" method="post" action="" id="addPaymentTerms">

                    <div class="form-group col-md-12">

                        <label for="exampleInputEmail1">Payment Terms</label>

                        <textarea rows="5" class="form-control pulsate" name="title" id="title" placeholder=""><?php echo isset($edit_terms->title) ? $edit_terms->title: ''; ?></textarea>
                    ...
                    <div class="form-group col-md-12 text-right">
                      ...
                      <button type="button" class="btn btn-success mb-2" onclick="saveProfile('addPaymentTerms','addPaymentTerms')">Submit</button>
                          ...
                          <?php $i=1; foreach ($payment_terms as $key => $value) { ?>
                            ...
                            <tr>
                              ...
                              <td style="width: 10%; word-wrap: break-word;">
                              	...
                              	<a title="View" type="button" id="<?=$value['id']; ?>" href="<?=  base_url('admin/app/payment_terms?action=edit&id='.$value['id'].''); ?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
<script>
    ...
    $(document).ready(function() {
      ...
      $(".delete_row").click(function(e){
        ...
        var deldata = {"id":getvalue,"table":'payment_terms'};
