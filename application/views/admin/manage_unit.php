    ...
    <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
                <form class="" method="post" action="" id="addUnit">
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1">Name</label>
                        <input type="text" class="form-control pulsate" name="name" id="name" value="<?php echo isset($edit_units->name) ? $edit_units->name: ''; ?>" placeholder="">
                    ...
                    <div class="form-group col-md-12 text-right">
                      <button type="button" class="btn btn-success mb-2" onclick="saveProfile('addUnit','addUnit')">Submit</button>
                    </div>
              </form>
            </div>
          </div>
            ...
            <div class="card-body">       
                <div class="table-responsive">
                    <table id="order-listing" class="table">
                        ...
                        <tbody>
                          <?php $i=1; foreach ($units as $key => $value) {?>
                            <tr>
                              <td style="width: 1%; word-wrap: break-word;"><?= $i; ?></td>
                              <td><?php echo $value['name']; ?></td>
                              <td>
                                <a type="button" id="<?=$value['id']; ?>" href="<?=  base_url('admin/app/units?action=edit&id='.$value['id'].''); ?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
<script>
    $(document).ready(function() {
        ...
        $(".delete_row").click(function(e){
            ...
            var deldata = {"id":getvalue,"table":'units'};
