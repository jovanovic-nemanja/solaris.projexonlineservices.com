        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
                ...
                <form class="pt-3" action="<?= base_url('index.php/admin/app/forgotpass'); ?>" method="post">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control form-control-lg border-left-0 email" name="email" id="" placeholder="Email ID"/>
                    ...
                    <div class="my-3">
                        <button type="submit" class="btn-lock" style="display: none;">SUBMIT</button>
                    </div>
                </form>
                <button type="button" class="btn btn-block btn-success btn-lg font-weight-medium auth-form-btn btn-login">SUBMIT</button>
            </div>
          </div>
            ...
            $('.btn-login').click(function() {
                ...
                if(!email) {
                    $.toast({
                      ...
                      text: 'The Email Id field cannot be blank.',
                      position: "top-right",
                      icon: 'success',
                      stack: false,
                      loaderBg: '#46c35f'
