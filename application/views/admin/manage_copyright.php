    ...
    <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              <form class="" method="post" action="" id="addcopyright">
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Description</label>
                  <textarea rows="3" class="form-control pulsate" name="description" id="description"><?php echo isset($edit_copyright->description) ? $edit_copyright->description: ''; ?></textarea>
                ...
                <div class="form-group col-md-12 text-right">
                  <button type="button" class="btn btn-success mb-2" onclick="saveProfile('addcopyright','addcopyright')">Submit</button>
                </div>
              </form>
            </div>
          </div>
            ...
            <div class="card-body">       
                <div class="table-responsive">
                    <table id="order-listing" class="table">
                        ...
                        <tbody>
                          <?php $i=1; foreach ($copyright as $key => $value) { ?>
                            <tr>
                              ...
                              <td style="width: 20%; word-wrap: break-word;">
                                <a title="View" type="button" id="<?=$value['id']; ?>" href="<?=  base_url('admin/app/copyright?action=edit&id='.$value['id'].''); ?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
<script>
    $(document).ready(function() {
        $(".delete_row").click(function(e){
            ...
            var deldata = {"id":getvalue,"table":'copyright'};
