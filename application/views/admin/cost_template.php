  	...
  	<div class="main-panel">
        <div class="content-wrapper">
          	<div class="page-header">
	            <h3 class="page-title">
	              Add New Cost Model (<?= $this->uri->segment(4); ?>)
	            </h3>
          	</div>
						  	...
						  	<div id="accordion-6" class="accordion accordion-multi-colored" role="tablist">
							 	...
							 	<div class="card">
									<div class="card-header" role="tab" id="heading-17">
									  	<h5 class="mb-0">
											<a data-toggle="collapse" href="#collapse-17" aria-expanded="false" aria-controls="collapse-17" referrerpolicy="origin" class="collapsed"> Cost Model Information </a>
									  	</h5>
									</div>
	                    		...
	                    		<div id="outer">
            					  	<div class="inner">
            					  		<form method="post" id="genrateTemplate">
            					  			...
            					  			<button type="button" class="btn msgBtn submitCostTemplate btn-success"><i class="fa fa-location-arrow" aria-hidden="true"></i>Save Cost Model</button>
            					  		</form>
            					  	</div>
            					</div>
	                      	</div>
    	...
    	$(document).ready(function(){
    		$('.submitCostTemplate').on('click', function(){
    			...
    			if(total_value == 0) {
    			    ...
    			    if(template_name != "" && cost_type != "")
        			{
        				genrateTemplate('genrateTemplate', 'saveCostTemplate');
        			}
        			else
        			{
