                                      ...
                                      <h6 class="mb-0">
                                        ...
                                        <div class="aa-bb">
            							  	<?php if($value['sumSellingCost']){ ?>
                							    <span class="ab-2"><span class="totcurr totalcostsum-<?= $value['cat_id']; ?> currencyConvert"><?= number_format(round($value['sumTotalCost'],0,PHP_ROUND_HALF_UP),2); ?></span></span>&nbsp; | &nbsp;
                								<span class="ab-2 totavg-<?= $value['cat_id']; ?>"><?= round($value['sumTotalCost']/$value['sumSellingCost'],2); ?></span>&nbsp; | &nbsp;
                								<span class="ab-3"><span class="selcurr sellingPriceSum-<?= $value['cat_id']; ?> currencyConvert"><?= number_format(round($value['sumSellingCost'],0,PHP_ROUND_HALF_UP),2); ?></span></span>
            								 <?php } else{ ?>
            											...
            											<a class="collapsed" role="button" data-toggle="collapse" href="#collapse-<?=$i?>-<?=$j?>" aria-expanded="false" aria-controls="collapse-1-1">
                											...
                											<div class="aa-bb" style="top: 0px;">
                												<?php if(!empty($subvalue['sumTotalCost'])){ ?>
                    												...
                    												<span class="ab-3"><span class="selcurr subsellingPriceSum-<?=$subvalue['id']; ?> currencyConvert"><?php echo ' '.number_format(round($subvalue['sumSellingCost'],0,PHP_ROUND_HALF_UP),2); ?></span></span>
                												<?php } else{ ?>
        			        ...
        			        <table class="table">
        					    <tbody>
        						  <tr>
        							...
        							<td style="width:20%;"><p class="text-right mb-0"><strong>AED &nbsp; <span class="totalsellingPrice"><?= number_format(round($costSheetTotal[0]->sellingPriceSum,0,PHP_ROUND_HALF_UP),2); ?></span></strong></p></td>
        						  </tr>
        						  <tr>
        							<td style="width:80%;">
        						  ...
        						  <tr>
        							<td style="width:80%;"><p class="text-right mb-0"><strong>Vat @ 5% (that’s it) <span class="discountTotal"><?= number_format(round($totalPrice,0,PHP_ROUND_HALF_UP),2); ?></span></strong></p></td>
