                                ...
                                <div class="card-body">
                                    <?php  if($costSheetTotal[0]->totalCostSum!=0){ ?>
                                        <div class="pp-to-ll" style="text-align:center;">
                                            <p>Price&nbsp;&nbsp;&nbsp;&nbsp;
                                                <span style="float: right;"><?= $costSheetData->currency ?><span class="currencyConvert"><?= number_format(round($costSheetTotal[0]->sellingPriceSum,3,PHP_ROUND_HALF_UP),2,'.',','); ?></span> 
                                                </span>
                                            </p>
                                        </div>
                                    <?php } ?>
                                    <div class="accordion accordion-bordered" id="accordion-2" role="tablist">
                                        <?php 
                                            $i =1; 
                                            foreach ($cost_sheet_cat as $key => $value) { 
                                                $alphas = range('A', 'Z'); ?>  
                                                    <div class="card">
                                                            ...
                                                            <a data-toggle="collapse" href="#collapse-<?= $i; ?>" aria-expanded="false" aria-controls="collapse-<?= $i; ?>" class="collapsed">
                                							  ...
                                							  <div class="aa-bb">
                                							  	<?php if($value['sumSellingCost']){ ?>
                                								    <span class="ab-3"><?= $costSheetData->currency ?>: <span class="currencyConvert"><?= number_format(round($value['sumSellingCost'],3,PHP_ROUND_HALF_UP),2,'.',','); ?></span></span>
                            								    <?php } ?>
                                							  </div>
                                                            </a>
                                                          </h6>
                                            							...
                                            							<div id="accordion-1" style="padding-bottom: 1%;">
                                            							    <div class="card">
                                            									<div class="card-header-2" id="heading-1-1">
                                            										<h5 class="mb-0">
                                            											<a class="collapsed" role="button" data-toggle="collapse"  aria-expanded="false" aria-controls="collapse-1-1">
                                            												<div class="subcat">
                                            													<h4 style="font-size: 1rem!important; width: 40%;">
                                            														...
                                            														<div class="aa-bb" style="">
                                            															<?php if(!empty($subvalue['sumTotalCost'])){ ?>
                                            															    <span class="ab-3"><?= $costSheetData->currency ?>: <span class="currencyConvert"><?php echo number_format(round($subvalue['sumSellingCost'],3,PHP_ROUND_HALF_UP),2,'.',','); ?></span></span>
                                            															<?php } ?>
                                            														 </div>
                                            													</h4>
                                            												</div>
                                													        ...
                                													        <?php if(!empty($lineItems)) { ?>
                                            												    <thead>
                                            													    <tr>
                                                														  ...
                                                														  <td>UNIT</td>
                                                														  <td style="width:34%">UNIT COST</td>
                                                														  <td>PRICE</td>
                                            													    </tr>
                                            												    </thead>
                                            												    <tbody>
                                            													    <?php $k=1; foreach ($lineItems as $key => $lineItem) { ?>
                                                													    <tr class="record">
                                                    														  ...
                                                    														  <td style="width:10%" class="">
                                                    														   ...
                                                    														   <td style="width:34%" class=""><p><span class="currencyConvert"><?php echo number_format(round($lineItem['unit_cost'],3,PHP_ROUND_HALF_UP),2,'.',','); ?></span></p>
                                                    														  </td> 
                        ...
                        <div class="col-md-6 mt-4 pl-4 text-left">
                            <?php if($costSheetData->quotation_status == 'Pending'){?>
    						   ...
    						   <form method="post" id="statusChange"> 
    							   ...
    							   <div class="form-group text-center">
    							       <button class="btn btn-lg btn-success" name="export" type="button" onclick="saveProfile('statusChange','quotationStatusChange');"  style="background-color: #3e4b5b;">Save</button>
    							   </div>
							    </form>
						    <?php } else{ ?>
								<div class="form-group">
