			                              	...
			                              	<div class="row">
			                              	  	<div class="col-md-3">
			                              	    	<form method="post" id="template_name">
														<label for="exampleInputEmail1">Job Name</label>
													  	<input type="text" class="form-control" name="template_Name" value="<?= $costSheetData->name; ?>" id="template_Name"  placeholder="" onchange ="updateFormData('template_name','updateTemplateName');" readonly="readonly">
													   	<input type="hidden" name="CostSheetId" value="<?= $this->uri->segment(4); ?>">
													</form>
			                              	  	</div>
			                              	  	<div class="col-md-3">
													<form method="post" id="costTypeForm">
														<label for="inputPassword4" class="">Job type</label>
												  		<select class="form-control select2" name="cost_type"  id="cost_type" style="width: 100%;" readonly="readonly" disabled>
														  	<option value="">Select</option>
												...
												<div class="col-md-3">
													<form method="post" id="venueForm">
														<label for="inputPassword4" class="">Venue</label>
													  	<select class="form-control select2" name="venue"  id="venue" style="width: 100%;" readonly="readonly" disabled>
															  <option value="">Select</option>
												...
												<div class="col-md-3">
													<form method="post" id="currencyForm">
														<label for="inputPassword4" class="">Currency</label>
													  	<select class="form-control select2" name="currency"  id="currency" style="width: 100%;" readonly="readonly" disabled>
														  	<option value="">Select</option>
					                              		...
					                              		<div class="aa-bb" style="top: -8px;">
    													  	<?php if($value['sumSellingCost']){ ?>
    														    <span class="ab-2" style="padding-right: 0px;">
    														    	<span class="totcurr totalcostsum-<?= $value['cat_id']; ?> currencyConvert"><?= number_format(round($value['sumTotalCost'],1,PHP_ROUND_HALF_UP),2); ?></span>&nbsp;|&nbsp;
    														    </span>
    															...
    															<span class="ab-3" style="padding-right: 25px;">
    																<span class="selcurr sellingPriceSum-<?= $value['cat_id']; ?> currencyConvert"><?= number_format(round($value['sumSellingCost'],1,PHP_ROUND_HALF_UP),2); ?></span>
    															</span>
    														<?php } else{ ?>
    														 	<span class="ab-2" style="padding-right: 0px;">
																		...
																		<a class="collapsed" role="button" data-toggle="collapse" href="#collapse-<?=$i?>-<?=$j?>" aria-expanded="false" aria-controls="collapse-1-1">
    																		...
    																		<div class="aa-bb" style="top: 0px;">
    																			<?php if(!empty($subvalue['sumTotalCost'])){ ?>
        																			<span class="ab-2"><span class="totcurr subtotalcostsum-<?=$subvalue['id']; ?> urrencyConvert"><?php echo ' '.number_format(round($subvalue['sumTotalCost'],1,PHP_ROUND_HALF_UP),2); ?> &nbsp;&nbsp; | &nbsp;&nbsp;</span></span>
        																			<span class="ab-2 avgoh-<?=$subvalue['id'];?>"><?php echo round ($subvalue['sumTotalCost']/$subvalue['sumSellingCost'],2); ?>&nbsp;&nbsp; | &nbsp;&nbsp;</span>
        																			<span class="ab-3" style="padding-right: 35px;"><span class="selcurr subsellingPriceSum-<?=$subvalue['id']; ?> currencyConvert"><?php echo ' '.number_format(round($subvalue['sumSellingCost'],1,PHP_ROUND_HALF_UP),2); ?></span></span>
    																			<?php } else{ ?>
																							...
																							<form method="post" id="lineItemForm-<?= $lineItem['id']; ?>">
																							 	<td style="width:13%" class="geeks">
																							  	...
																							  	<td style="width:14%" class="">
																								   	<p style="color: green;"><span class="currencyConvert"><?= number_format(round($lineItem['total_cost'],1,PHP_ROUND_HALF_UP),2); ?></span></p>
																							  	</td>
																							  	<td style="width:10%" class="">
																							  	...
																							  	<td style="width:40%" class="">
																								   	<p style=""><span class="currencyConvert"><?= number_format(round($lineItem['selling_price'],1,PHP_ROUND_HALF_UP),2); ?></span></p>
																							  	</td>
																							</form>
																					  	</tr>
																					<?php $k++; } ?>
                    				     ...
                    				     <table class="table">
                    					    <tbody>
                    						  <tr>
                    							...
                    							<td style="width:50%;"><p class="text-right mb-0"><strong>AED <span class="totalsellingPrice"><?= number_format(round($costSheetTotal[0]->sellingPriceSum,1,PHP_ROUND_HALF_UP),2); ?></span></strong></p></td>
                    						  </tr>
                    						  <tr>
                    							<td style="width:50%;">
                    							...
                    							<?php 
                    							 ...
                    							 ?>
                    							<td style="width:50%;"><p class="text-right mb-0"><strong ><span class="discountPrice">AED <?= number_format(round($disPrice,1,PHP_ROUND_HALF_UP),2); ?></span></strong></p></td>
                    						  </tr>
                    						  <tr>
                    							<td style="width:50%;"><p class="text-right mb-0"><strong>Total after discount</strong></p></td>
                    							<td style="width:50%;"><p class="text-right mb-0"><strong><span class="totalarterDis">AED <?= number_format(round($totalPrice,1,PHP_ROUND_HALF_UP),2); ?></span></strong></p></td>
                    						  </tr>
                    						  <tr>
                    							<td style="width:50%;"><p class="text-right mb-0"><strong>Vat @ 5%</strong></p></td>
                    							<td style="width:50%;"><p class="text-right mb-0"><strong><span class="vatPrice">AED <?= number_format(round($calculateVat,1,PHP_ROUND_HALF_UP),2); ?></span></strong></p></td>
                    						  </tr>
                    						  
                    						  <tr>
                    							<td style="width:60%;"><p class="text-right mb-0"><strong>Total including tax</strong></p></td>
                    							<td style="width:40%;"><p class="text-right mb-0"><strong><span class="total">AED <?= number_format(round($totalCost,1,PHP_ROUND_HALF_UP),2); ?></span></strong></p></td>
                    						  </tr>
                    						</tbody>
                    				    </table>
                    				</div>
