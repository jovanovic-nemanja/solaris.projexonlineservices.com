                ...
                <div class="row">
                  <div class="col-lg-12 admin-accord">
                    <div class="card-body">
                       ...
                       <div class="pp-to-ll" style="text-align: center;"><p>Cost: <span style="float: right;" >AED <?= number_format(round($costSheetTotal[0]->totalCostSum,3,PHP_ROUND_HALF_UP),2,'.',','); ?></span></p>| <p>Average O/H: <span style="" ><?= round($costSheetTotal[0]->totalCostSum/$costSheetTotal[0]->sellingPriceSum,2); ?></span></p> | <p>Price: <span style="float: right;">AED <?= number_format(round($costSheetTotal[0]->sellingPriceSum,3,PHP_ROUND_HALF_UP),2,'.',','); ?> </span></p></div>
                       <?php } ?>
                          ...
                          <h6 class="mb-0">
                            <a data-toggle="collapse" href="#collapse-<?= $i; ?>" aria-expanded="false" aria-controls="collapse-<?= $i; ?>" class="collapsed">
							  ...
							  <div class="aa-bb">
							    ...
							    <span class="ab-2"><?= number_format(round($value['sumTotalCost'],3,PHP_ROUND_HALF_UP),2,'.',','); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="ab-2"><?= round($value['sumTotalCost']/$value['sumSellingCost'],2); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="ab-3"><?= number_format(round($value['sumSellingCost'],3,PHP_ROUND_HALF_UP),2,'.',','); ?></span>
								 <?php } ?>
							  </div>
												...
												<div class="subcat">
													<h4 style="font-size: 1rem!important;">
														...
														<div class="aa-bb" style="">
															...
															<span class="ab-2"><?php echo number_format(round($subvalue['sumTotalCost'],3,PHP_ROUND_HALF_UP),2,'.',','); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
															<span class="ab-2"><?php echo round ($subvalue['sumTotalCost']/$subvalue['sumSellingCost'],2); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
															<span class="ab-3"><?php echo number_format(round($subvalue['sumSellingCost'],3,PHP_ROUND_HALF_UP),2,'.',','); ?></span>
															<?php } ?>
												  ...
												  <tbody>
													  ...
													  <tr class="record">
														  ...
														  <td style="width:14%" class="">
															   <p style=""><?= number_format(round($lineItem['total_cost'],3,PHP_ROUND_HALF_UP),2,'.',','); ?></p>
														  </td>
														  <td style="width:10%" class=""><p><?=$lineItem['o/h']; ?></p>
														  </td>
														  <td style="width:10%" class="">
															   <p style=""><?= number_format(round($lineItem['selling_price'],3,PHP_ROUND_HALF_UP),2,'.',','); ?></p>
														  </td>
                  ...
                  <div class="row mt-3" style='padding: 25px;'>
		        <div class="col-md-6">
				</div>
				<div class="col-md-6">
				     <table class="table">
					    <tbody>
						  <tr>
							...
							<td style="width:20%;"><p class="text-right mb-0"><strong>AED <?= number_format(round($costSheetTotal[0]->sellingPriceSum,3,PHP_ROUND_HALF_UP),2,'.',','); ?></strong></p></td>
						  </tr>
						  <tr>
							<td style="width:80%;">
				    ...
				    <div id="outer">
                      ...
                      <div class="row">	
                        <div class="col-md-6 mt-4 pl-4 text-left"></div>
							...
							<?php } else{ ?>
							   ...
							   <div class="form-group">
							        <label>Download pdf</label>
									 <a target="_blank" href="<?= base_url('uploads/quotationpdf/').$costSheetData->quotation_pdf; ?>"><span class="d-block mt-2"><img src="<?= base_url(); ?>/admin_assets/images/pdf-image.png"  style=" height: 70px;" class=""img-fluid></span></a>
							   </div>
							<?php } } ?>
						  </div> 
					...
					<div class='card-body'>
		                    <div class='row'>
    						   ...
    						   <form method="post" id="statusChange" style='width: 100%;' action='<?= base_url('admin/app/addCostcomment'); ?>'> 
    							   <div class="form-group">
    							        <label>Comment</label>
    									<textarea class="form-control ff-fdd" name="comment" value="" id="comment" style="width: 100%;" rows="5" id="" placeholder="Please enter the comment." required></textarea>
                						   ...
                						   <form method="post" id="statusChange" style='width: 100%;' action='<?= base_url('admin/app/addJobcomment'); ?>'> 
                							   <div class="form-group">
                							        <?php 
                                                        ...
                                                        $created_at = date_format($d,"F d, Y  H:i:s");
                							        ?>
            							            <label>Creator: <?= $value['username']; ?>&nbsp;&nbsp;&nbsp; (<?= $created_at; ?>)</label>
                									<textarea class="form-control ff-fdd" name="comment" id="comment" style="width: 100%;" rows="5" disabled><?= $value['comment']; ?></textarea>
                									<input type="hidden"  name="cost_sheet_id" value="<?= $this->uri->segment(4); ?>">
                							   </div>
            							    </form>
                					    </div>
